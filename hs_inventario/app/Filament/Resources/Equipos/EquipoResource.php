            ...
            ->actions([
                Action::make('ver')
                    ...
                    ->url(fn($record) => match($record->Nombre_equipos) {
                        'Bombas' => route('filament.admin.resources.bombas.index'),
                        'Cilindros' => route('filament.admin.resources.cilindros.index'),
                        'Cabezales' => route('filament.admin.resources.cabezales.index'),
                        'Dados' => route('filament.admin.resources.dados.index'),
                        'Pistolas' => route('filament.admin.resources.pistolas.index'),
                        default => '#',
                    }),
                ])
            ->filters([
